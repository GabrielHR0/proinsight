...
@TypeAlias("persistedNivelImc")
public class PersistedNivelImc extends PersistedLeaf {
    ...
    public PersistedNivelImc() {}

    public PersistedNivelImc(String classificacao, Double min, Double max) {
        this(classificacao, min, max, null, null);
    }

    public PersistedNivelImc(String classificacao, Double min, Double max, TipoLimite tipoMin, TipoLimite tipoMax) {
