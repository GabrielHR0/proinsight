...
@TypeAlias("persistedNivelVo2Max")
public class PersistedNivelVo2Max extends PersistedLeaf {
    ...
    public PersistedNivelVo2Max() {}

    public PersistedNivelVo2Max(String classificacao, Double min, Double max) {
        this(classificacao, min, max, null, null);
    }

    public PersistedNivelVo2Max(String classificacao, Double min, Double max, TipoLimite tipoMin, TipoLimite tipoMax) {
